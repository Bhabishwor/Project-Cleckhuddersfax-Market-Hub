...
<body>
    ...
    <div id="product_images">
        <div id="main_image_container">
            <img src="../../Image/products/product1.jpeg" alt="Product Image" id="main_image">
        </div>
        <div id="thumbnail_images">
            <div class="thumbnail_container">
                <img src="../../Image/products/product1.jpeg" alt="Thumbnail 1" class="thumbnail" data-index="0">
            </div>
            <div class="thumbnail_container">
                <img src="../../Image/products/product2.jpeg" alt="Thumbnail 2" class="thumbnail" data-index="1">
            </div>
            <!-- Add more thumbnail images as needed -->
            <div class="thumbnail_container">
                <img src="../../Image/products/product1.jpeg" alt="Thumbnail 3" class="thumbnail" data-index="1">
            </div>
        </div>
    </div>
