...
if ($product_id > 0) {
    ...
    oci_bind_by_name($stmt_trader, ':trader_id', $product['USER_ID']);
    ...
    $sql_reviews = "SELECT R.*, C.USER_NAME 
                    FROM REVIEWS R 
...
<head>
    ...
    <style>
        ...
        /* Add Review Section Submit Button Hover */
    ...
    <div class="container product-container">
        <div class="row">
            ...
            <div class="col-md-6 product-detail">
                ...
                <?php else: ?>
                    <p class="product-description"><strong>Stock:</strong>
                        <?php echo htmlspecialchars($product['STOCK']); ?></p>
                <?php endif; ?>
                <div class="product-description-container">
                    <p class="product-description"><strong>Allergy Information:</strong>
                        <?php echo htmlspecialchars($product['ALLERGY_INFORMATION']); ?></p>
                </div>
                <div class="trader-info">
                    <img src="<?php echo htmlspecialchars($trader['USER_SHOP_IMAGE']); ?>"
                        alt="<?php echo htmlspecialchars($trader['USER_NAME']); ?>" class="trader-img">
                    <h5><a
                            href="trader_info.php?id=<?php echo htmlspecialchars($trader['USER_ID']); ?>"><?php echo htmlspecialchars($trader['USER_NAME']); ?></a>
                    </h5>
                </div>
                <?php if ($product['STOCK'] > 0): ?>
                    <form method="get" action="manage_cart.php">
                        ...
                        <input type="hidden" name="stock" value="<?php echo htmlspecialchars($product['STOCK']); ?>">
                        <button type="submit" class="btn btn-primary" name="cartBtn">
        ...
        <?php if (count($reviews) > 0): ?>
            <?php foreach ($reviews as $review): ?>
                <div class="review">
                    ...
                    <div class="customer-name"><?php echo htmlspecialchars($review['USER_NAME']); ?></div>
    ...
    <div class="container add-review-section">
        ...
        <form method="post" action="add_review.php">
            ...
            <div class="mb-3">
                ...
                <textarea id="review_description" name="Review_Description" class="form-control" rows="4"
                    required></textarea>
            </div>
