...
handleFormSubmission('#registrationForm', 'register.php', 'error_container', 'login.html');
handleFormSubmission('#customerLogin', 'customer_login_request.php', 'error_customerLogin', 'homepage.php');
